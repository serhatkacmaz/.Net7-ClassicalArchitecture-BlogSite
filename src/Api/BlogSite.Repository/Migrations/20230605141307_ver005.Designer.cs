...
namespace BlogSite.Repository.Migrations
{
    ...
    [Migration("20230605141307_ver005")]
    partial class ver005
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogSite.Core.Entities.UserBase.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 6, 5, 17, 13, 7, 227, DateTimeKind.Local).AddTicks(6361),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 6, 5, 17, 13, 7, 227, DateTimeKind.Local).AddTicks(6378),
            ...
            modelBuilder.Entity("BlogSite.Core.Entities.UserBase.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 6, 5, 17, 13, 7, 227, DateTimeKind.Local).AddTicks(6715),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 6, 5, 17, 13, 7, 227, DateTimeKind.Local).AddTicks(6736),
                            Image = new byte[] { 255, 216, 255, 224, 0, 16, 74, 70, 73, 70, 0, 1, 1, 0, 0, 1, 0, 1, 0, 0, 255, 219, 0, 132, 0, 8, 6, 6, 7, 6, 5, 8, 7, 7, 7, 9, 9, 8, 10, 12, 20, 13, 12, 11, 11, 12, 25, 18, 19, 15, 20, 29, 26, 31, 30, 29, 26, 28, 28, 32, 36, 46, 39, 32, 34, 44, 35, 28, 28, 40, 55, 41, 44, 48, 49, 52, 52, 52, 31, 39, 57, 61, 56, 50, 60, 40, 51, 52, 50, 255, 219, 0, 132, 1, 9, 9, 9, 12, 11, 12, 24, 13, 13, 24, 50, 33, 28, 33, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50 },
                            IsActive = true,
            ...
            modelBuilder.Entity("BlogSite.Core.Entities.UserBase.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 6, 5, 17, 13, 7, 227, DateTimeKind.Local).AddTicks(6612),
                            IsActive = true,
                            Role_ID = 1,
                            User_ID = 1
                        },
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 6, 5, 17, 13, 7, 227, DateTimeKind.Local).AddTicks(6614),
                            IsActive = true,
                            Role_ID = 2,
                            User_ID = 2
                        });
