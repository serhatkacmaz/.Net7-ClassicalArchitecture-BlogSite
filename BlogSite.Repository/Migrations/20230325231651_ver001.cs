    ...
    public partial class ver001 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 3, 26, 2, 16, 51, 352, DateTimeKind.Local).AddTicks(2908), "admin rolu tanımlama.", true, "admin", null, null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "About", "CreatedDate", "Image", "IsActive", "Mail", "Name", "Password", "Title", "UpdatedDate", "UserName", "User_ID" },
                values: new object[] { 1, null, new DateTime(2023, 3, 26, 2, 16, 51, 352, DateTimeKind.Local).AddTicks(3280), null, true, "admin@gmail.com", "admin", "1234", "Manager", null, "admin Name", null });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "Id", "CreatedDate", "IsActive", "Role_ID", "UpdatedDate", "User_ID" },
                values: new object[] { 1, new DateTime(2023, 3, 26, 2, 16, 51, 352, DateTimeKind.Local).AddTicks(3194), true, 1, null, 1 });
